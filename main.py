...
@app.post("/prediction")
async def predict_sentiment(product_reviews: ProductReviews):
	coroutines = [asyncio.to_thread(classify_sentiment, review) for review in product_reviews.reviews]
